...
def generate_safety_token(length: int = 64, /) -> str:
...
def natural_time(  # noqa: C901 # time is a complicated thing after all
    ...
    *,
    ...
    if minutes and not years and not months and not weeks and not days and not hours:  # noqa: PLR0916 # but this makes it logically readable
        if ret:
            ret += ", "
