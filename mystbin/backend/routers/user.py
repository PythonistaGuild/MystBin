...
@openapi.instance.route(
    openapi.Route(
        ...
        None,
        [],
        {200: openapi.Response("Success", openapi.User), 401: openapi.UnauthorizedResponse},
        description=desc,
...
@openapi.instance.route(
    openapi.Route(
        ...
        {204: openapi.Response("Success", None), 401: openapi.UnauthorizedResponse},
        description=desc,
        is_body_required=False,
    )
)
...
@openapi.instance.route(
    openapi.Route(
        ...
        None,
        [],
        {200: openapi.Response("Success", openapi.BookmarkResponse), 401: openapi.UnauthorizedResponse},
        description=desc,
    )
)
@limit("bookmarks")
...
@openapi.instance.route(
    openapi.Route(
        ...
        None,
        [],
        {200: openapi.Response("Success", openapi.TokenListResponse), 401: openapi.UnauthorizedResponse},
        description=desc,
        is_body_required=False,
    )
)
...
async def get_tokens(request: MystbinRequest):
    ...
    return VariableResponse(
        responses.TokenList(
            [
                responses.TokenListItem(
                    id=x["id"], name=x["token_name"], description=x["token_description"], is_web_token=x["is_main"]
                )
                for x in data
            ]
        ),
