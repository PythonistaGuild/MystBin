            ...
            <Modal
                ...
                <Modal.Header className={styles.loginModalHeader}>
                    <Modal.Title className={styles.loginModalTitle}>
                        <LogoMain className={styles.logo}/><br/>
                        Login
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body className={styles.loginModalBody}>
                    <div className={styles.iconsContainer} onClick={() => {router.push('/')}}>
                ...
                <Modal.Footer>
                    <small>By logging in via one of the provided routes above, you agree to our <a href={'/'}>Terms and Conditions</a>, <a href={'/'}>Privacy Policy </a>
                    and consent to our <a href={'/'}>Cookie Policy</a>.</small>
                </Modal.Footer>
            </Modal>
            </>
